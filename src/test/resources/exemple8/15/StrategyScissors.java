...
// compilation depuis le répertoier src : javac -d ../classes ./ppc/util/strat/StrategyScissors.java
...
public class StrategyScissors implements Strategy{
	...
	// METHODES
	/*
	 * Builds an instance of type StrategyScissors.
	 */
	//public StrategyScissors();
	 ...
	 */
	public Shape get(){
		return Shape.getShape("scissors");
	}
	...
	public boolean equals(Object o){
		return (o instanceof StrategyScissors);
	}
}
